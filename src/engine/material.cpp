...
void genmatsurfs(cube &c, int cx, int cy, int cz, int size, vector<materialsurface> &matsurfs)
{
    loopi(6)
    {
        static uchar matmasks[] = { MATF_VOLUME, MATF_CLIP, MAT_DEATH, MAT_PAIN, MAT_ALPHA };
    ...
    loopvrev(editsurfs)
    {
        ...
        if(m.material != lastmat)
        {
            ...
            switch(m.material)
            {
                ...
                case MAT_PAIN:     color = bvec(70, 30, 10); break; // brown
    ...
    loopv(editsurfs)
    {
        ...
        if(lastmat!=m.material)
        {
            ...
            switch(m.material)
            {
                ...
                case MAT_PAIN:     color = bvec( 96, 160, 255); break; // brown
