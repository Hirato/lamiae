...
Windows
1. Install Codeblocks ( http://www.codeblocks.org/ ) and mingw with SILJ bindings ( http://tdm-gcc.tdragon.net/download )
2. Open up the codeblocks project file in src/windows/lamiae.cbp
3. Click build
